...
camera_label.place(x=800, y=470)  # تنظیم موقعیت ویجت در پایین سمت راست
...
def data_save():
    ...
    if zeroo:
        print (1)
        lab_v_kh = tk.CTkLabel(master=frame, text= data_saved, font=("Roboto", 18), text_color="blue")
...
def run_another_script():
    ...
    while running:
        ...
        try:
            ...
            # print(type(face_encoding_camera))
            ...
            for image_file in data_info["accounts"]:
                ...
                try:
                    ...
                    # تبدیل رشته به یک آرایه numpy با استفاده از مقدار پیش‌فرض
                    face_encoding1 = np.array(eval(face_code) if face_code else np.array([]))
        ...
        if zero:
            label12 = tk.CTkLabel(master=frame, text=x, font=("Roboto", 14))
